defmodule TestProjectWeb.OrderControllerTest do
  ...
  describe "update order" do
    ...
    test "redirects when data is valid", %{conn: conn, order: order} do
      ...
      assert html_response(conn, 200) =~ "some updated customer"
    end
